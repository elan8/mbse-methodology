...
These are **not** sequential lifecycle phases. They are perspectives that evolve together. A vertical engineering increment typically touches several concerns in one coherent change.
