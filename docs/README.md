...
| [tailoring.md](tailoring.md) | Small / medium / regulated profiles |
...
| [spec42-quality-contract.md](spec42-quality-contract.md) | Contracted Spec42 diagnostics (not implemented yet) |
| [library-migration.md](library-migration.md) | SE packages moved to this repo (complete) |
